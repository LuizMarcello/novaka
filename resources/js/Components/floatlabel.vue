...
@font-face {
    ...
    font-display: block;
    src: url('http://127.0.0.1:5173/node_modules/primeicons/fonts/primeicons.eot');
    src: url('http://127.0.0.1:5173/node_modules/primeicons/fonts/primeicons.eot?#iefix') format('embedded-opentype'), url('http://127.0.0.1:5173/node_modules/primeicons/fonts/primeicons.ttf') format('truetype'), url('http://127.0.0.1:5173/node_modules/primeicons/fonts/primeicons.woff') format('woff'), url('http://127.0.0.1:5173/node_modules/primeicons/fonts/primeicons.svg?#primeicons') format('svg');
    font-weight: normal;
    font-style: normal;
}
